  ...
  return (
    <header className="h-[52px] flex-none flex items-center gap-5 px-4 bg-panel border-b border-border font-ui">
      <div className="flex items-center gap-2">
        ...
        <span className="font-bold tracking-wide text-[13.5px] text-text">SURGE</span>
        <span className="text-[11.5px] text-textFaint ml-2 pl-2 border-l border-borderStrong">
