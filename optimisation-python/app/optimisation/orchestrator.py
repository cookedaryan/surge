...
def derive_land_constraint_layers(project_input: ProjectInput) -> tuple[ConstraintLayer, ...]:
    ...
    for parcel in project_input.project_data.parcels:
        ...
        if profile.availability_status == LandAvailabilityStatus.UNAVAILABLE:
            ...
            # Search Engine Enrichment: Prefer routes with fewer interactions or lower land costs
...
def optimise_project(
    ...
    *,
    ...
    land_economic_context_id = compute_land_economic_context_id(project_input.land_context)
