...
This document defines what SURGE must do for its users, why, and how success is measured. It does not prescribe implementation — see the [TRD](../architecture/TRD.md) for that.
